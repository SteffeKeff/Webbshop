...
public class Main
{
        ...
        public static void main(String[] args)
        {
                ...
                ss.addCustomer(new Customer("Be", "oz", "beoz@hotmail.com", "be", "oz", "Nyn�sv�gen 1", "070123456789"));
               
                ss.addProduct(new Product("Klassisk pannkaka", "Pannkakor" , "Stefan", "V�r klassiska och mycket uts�kta pannkaka", "klassiskPannkaka.png", 10.90, 60));
                ss.addProduct(new Product("Amerikansk pannkaka", "Pannkakor" , "Erik", "En tjockare variant �n den klassiska pannkakan men otroligt god och passar till sirap", "amerikanskPannkaka.png", 13.90, 40));
                ss.addProduct(new Product("Belgisk v�ffla", "V�fflor", "Osama", "Den belgiska v�fflan �r lite tjock och mycket frasig", "belgiskVaffla.png", 12.90, 50));
                ...
                ss.getCustomer("Be").addProduct(ss.getProduct("Belgisk v�ffla"));

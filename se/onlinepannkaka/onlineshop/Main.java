...
public class Main 
{
	...
	public static void main(String[] args) 
	{
		...
		ss.addProduct(new Product("Amerikansk pannkaka", "Pannkakor" , "Erik", "En lite tjockare men mycket god pannkaka som passar till sirap", "amerikanskPannkaka.png", 13.90, 40));
